...
type Segments = {
  ...
  r2L: string;
  /** row 2 eyes (with bg): left-eye, forehead, right-eye */
  r2E: string;
  /** row 2 right (no bg): body curve + arm */
  r2R: string;
  /** row 3 left (no bg): bottom left */
  r3L: string;
  /** row 3 base (with bg): hill base */
  r3E: string;
  /** row 3 right (no bg): bottom right */
  r3R: string;
};
...
export function Clawd(t0) {
  ...
  let t11;
  if ($[24] !== p.r3L) {
    t11 = <Text color="clawd_body">{p.r3L}</Text>;
    $[24] = p.r3L;
    $[25] = t11;
  } else {
    t11 = $[25];
  ...
  let t12;
  if ($[26] !== p.r3E) {
    t12 = <Text color="clawd_body" backgroundColor="clawd_background">{p.r3E}</Text>;
    $[26] = p.r3E;
    $[27] = t12;
  } else {
    t12 = $[27];
  ...
  let t13;
  if ($[28] !== p.r3R) {
    t13 = <Text color="clawd_body">{p.r3R}</Text>;
    $[28] = p.r3R;
    $[29] = t13;
  } else {
    t13 = $[29];
  ...
  let t15;
  if ($[34] !== t10 || $[35] !== t6 || $[36] !== t14) {
    t15 = <Box flexDirection="column">{t6}{t10}{t14}</Box>;
    $[34] = t10;
    $[35] = t6;
    $[36] = t14;
    $[37] = t15;
...
function AppleTerminalClawd(t0) {
  ...
  let t4;
  if ($[3] !== t1) {
    t4 = <Box flexDirection="column">{t1}{t2}{t3}</Box>;
    $[3] = t1;
    $[4] = t4;
  } else {
    t4 = $[4];
